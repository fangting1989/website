...
@Component({
  selector: 'workflow-component-panel-empty',
  templateUrl: './component-panel-empty.component.html',
  styleUrls: ['./component-panel-empty.component.scss']
})
export class ComponentPanelEmptyComponent implements OnInit {
  taskId: any;
