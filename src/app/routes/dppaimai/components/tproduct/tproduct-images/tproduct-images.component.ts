...
@Component({
  selector: 'paimai-tproduct-images',
    ...
    if (this.Images.length > 0) {
      ...
      _.each(this.Images, function (obj) {
        if (typeof obj.content != 'undefined') {
          ...
          formData.append("tablename", self.image_type);
          formData.append("filepath",self.image_type)
