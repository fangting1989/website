...
@Component({
  selector: 'paimai-twebcore-edit',
  templateUrl: './twebcore-edit.component.html',
  styleUrls: ['./twebcore-edit.component.scss']
})
export class TWebcoreEditComponent implements OnInit {
  data: any;
  model: any = {}
  EnterPriseCode: any;
  ...
  /*loadData(){
    ...
    this.dataServices.twebcoreList(this.model).subscribe(result => {
