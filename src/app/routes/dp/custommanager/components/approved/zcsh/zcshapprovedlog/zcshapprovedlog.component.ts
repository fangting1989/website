...
@Component({
  selector: 'app-zcshapprovedlog',
  templateUrl: './zcshapprovedlog.component.html',
  styleUrls: ['./zcshapprovedlog.component.scss']
})
export class ZcshapprovedlogComponent implements OnInit {
  DataList:any = []
  searchObject:any = {};
  PageNum:any = 1;
  PageSize:any = 10;
