...
@Component({
  selector: 'app-approved-zcsh',
  templateUrl: './approved-zcsh.component.html',
  styleUrls: ['./approved-zcsh.component.scss']
})
export class ApprovedZcshComponent implements OnInit {
  data: any;
  dataItem: any = {}
  model: any = {}
  modelyj:any = {}
  ...
  ProinstSubmit(){
    ...
    this.modalService.confirm({
      ...
      nzOnOk      : () => {
        ...
        self.dataServices.zcsh(postData).subscribe(result => {
          if (result != null) {
