...
@Component({
  selector: 'app-approved-psyspre',
  templateUrl: './approved-psyspre.component.html',
  styles: []
})
export class ApprovedPsyspreComponent implements OnInit {
  data: any;
  dataItem: any = {}
  model: any = {}
  modelzx:any = {}
  ...
  ProinstSubmit(){
    ...
    this.modalService.confirm({
      ...
      nzOnOk      : () => {
        ...
        self.dataServices.tpartner_psyspretg(postData).subscribe(result => {
          if (result != null) {
