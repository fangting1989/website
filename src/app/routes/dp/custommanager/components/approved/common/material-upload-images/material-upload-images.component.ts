...
@Component({
  selector: 'app-component-material-upload-images',
  templateUrl: './material-upload-images.component.html',
  styleUrls: ['./material-upload-images.component.scss']
})
export class MaterialUploadImagesComponent implements OnInit {
    ...
    if (this.Images.length > 0) {
      ...
      _.each(this.Images, function (obj) {
        if (typeof obj.content != 'undefined') {
          ...
          formData.append("tablename",  self.model.imgtype);
          formData.append("filepath",self.model.imgtype)
