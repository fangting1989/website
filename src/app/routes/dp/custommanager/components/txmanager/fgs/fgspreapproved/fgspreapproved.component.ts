...
@Component({
  selector: 'app-fgspreapproved',
  templateUrl: './fgspreapproved.component.html',
  styleUrls: ['./fgspreapproved.component.scss']
})
export class FgspreapprovedComponent implements OnInit {
  DataList:any = []
  searchObject:any = {};
  PageNum:any = 1;
  PageSize:any = 10;
