...
@Component({
  selector: 'app-outmoneydetail',
  templateUrl: './outmoneydetail.component.html',
  styleUrls: ['./outmoneydetail.component.scss']
})
export class OutmoneydetailComponent implements OnInit {
  @Input() dataItem:any
  EnterPriseCode:any;
  modelbh:any = {}
  ProinstList:any;
