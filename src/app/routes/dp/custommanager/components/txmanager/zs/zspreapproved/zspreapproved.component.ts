...
@Component({
  selector: 'app-zspreapproved',
  templateUrl: './zspreapproved.component.html',
  styleUrls: ['./zspreapproved.component.scss']
})
export class ZspreapprovedComponent implements OnInit {
  DataList:any = []
  searchObject:any = {};
  PageNum:any = 1;
  PageSize:any = 10;
