...
@Component({
  selector: 'app-ddklogpage',
  templateUrl: './ddklogpage.component.html',
  styleUrls: ['./ddklogpage.component.scss']
})
export class DdklogpageComponent implements OnInit {
  ...
  loadData(){
    ...
    var postData = {
      ...
      operatepersion:this.comservices.getUserCode,
      isvalid:1040
    }
