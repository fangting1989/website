...
@Component({
  selector: 'app-dsk-images',
  templateUrl: './dsk-images.component.html',
  styleUrls: ['./dsk-images.component.scss']
})
export class DskImagesComponent implements OnInit {
  tablename_key:any = 'needmoney-dsk-img'
  Images: any = [];
  ...
  UpdateNeedMoney(){
    ...
    var postData = {
      ...
      suredate:moment(),
      surepersion:this.comservices.getUserName,
      isvalid:99
    }
    this.dataServices.tneedmoneyUp(postData).subscribe(result => {
      this.submitting = false
      if (result != null) {
