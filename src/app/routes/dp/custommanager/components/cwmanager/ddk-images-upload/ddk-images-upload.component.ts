...
@Component({
  selector: 'app-ddk-images-upload',
  templateUrl: './ddk-images-upload.component.html',
  styleUrls: ['./ddk-images-upload.component.scss']
})
export class DdkImagesUploadComponent implements OnInit {
  tablename_key:any = 'tx-money-ddk'
  Images: any = [];
    ...
    if (this.Images.length > 0) {
      ...
      _.each(this.Images, function (obj) {
        if (typeof obj.content != 'undefined') {
          ...
          formData.append("tablename", self.tablename_key);
          formData.append("filepath",self.tablename_key)
