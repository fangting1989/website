...
@Component({
  selector: 'app-tcustomer-list',
  templateUrl: './tcustomer-list.component.html',
  styleUrls: ['./tcustomer-list.component.scss']
})
export class TCustomerListComponent implements OnInit {
  DataList:any = []
  searchObject:any = {};
  PageNum:any = 1;
  PageSize:any = 10;
