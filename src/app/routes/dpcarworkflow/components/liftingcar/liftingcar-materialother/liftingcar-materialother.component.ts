...
@Component({
  selector: 'dpworksiteservices-liftingcar-materialother',
  templateUrl: './liftingcar-materialother.component.html',
  styles: []
})
export class LiftingcarMaterialotherComponent extends WorkflowBaseComponent implements OnInit {
  @ViewChild('materialcomponent') materialcomponent:MaterialSaveComponent

  proctask:any;
  materialname:any = 'tccl-other-material'
  EnterPriseCode:any;
