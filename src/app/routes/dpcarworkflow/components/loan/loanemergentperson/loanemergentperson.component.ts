...
@Component({
  selector: 'dpworksiteservices-loanemergentperson',
  templateUrl: './loanemergentperson.component.html',
  styleUrls: ['./loanemergentperson.component.scss']
})
export class LoanemergentpersonComponent extends WorkflowBaseComponent implements OnInit {
