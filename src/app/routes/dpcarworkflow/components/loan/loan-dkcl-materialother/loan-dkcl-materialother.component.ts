...
@Component({
  selector: 'dpworksiteservices-loan-dkcl-materialother',
  templateUrl: './loan-dkcl-materialother.component.html',
  styles: []
})
export class LoanDkclMaterialotherComponent extends WorkflowBaseComponent implements OnInit {
  @ViewChild('materialcomponent') materialcomponent:MaterialSaveComponent

  proctask:any;
  materialname:any = 'dkcl-other-material'
  EnterPriseCode:any;
