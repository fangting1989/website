...
export class TProrejectedListComponent implements OnInit {
  ...
  addClick(record: any = {}){
    ...
    const modal = this.modalHelper.create(TProrejectedEditComponent,{ data: data},{size:800}).subscribe(res => {
      this.loadData()
    });
  }
  ...
  deleteItem(item){
    ...
    this.modalService.confirm({
      ...
      nzOnOk      : () => {
        ...
        self.dataServices.tprorejectedDel(postData).subscribe(result => {
          if (result != null) {
